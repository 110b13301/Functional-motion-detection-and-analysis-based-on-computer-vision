...
require 'C:/AppServ/php7/vendor/autoload.php';// 如果用 composer 安裝
require 'C:/AppServ/php7/vendor/phpmailer/phpmailer/src/PHPMailer.php';
require 'C:/AppServ/php7/vendor/phpmailer/phpmailer/src/SMTP.php';
require 'C:/AppServ/php7/vendor/phpmailer/phpmailer/src/Exception.php';
    ...
    if ($stmt->execute()) {
        if ($stmt->affected_rows > 0) {
            ...
            try {
                ...
                // 收件人與寄件人設定
                $mail->setFrom('skes98055@gmail.com', '潔身明白'); // 寄件人
                $mail->addAddress($email); // 收件人
                $mail->addReplyTo('skes98055@gmail.com', '潔身明白');
