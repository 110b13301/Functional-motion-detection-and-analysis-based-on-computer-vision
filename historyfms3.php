...
// 根據選擇的日期查詢資料
$sql = "SELECT * FROM recordfms3 WHERE user_id = ? ";
$params = [$user_id];
	...
	<div class="row">
		<div class="col-lg-12">
			...
			<div id="day" class="post-tags my-5 text-uppercase font-size-12 letter-spacing text-center">
				...
				<br><br>
				<div id="content0"></div>
                    <form method="POST" action="historyfms3.php">
                        ...
                        <tbody>
                            <?php while ($row = $result->fetch_assoc()): ?>
                                <tr>
									...
									<td><?php echo htmlspecialchars($row['tibial']); ?>cm</td>
		...
		<div id="month" class="post-tags my-5 text-uppercase font-size-12 letter-spacing text-center">
			...
			<?php
				...
				$sql = "SELECT date, MAX(total_record) as max_total_record FROM recordfms3 WHERE user_id = ? AND date BETWEEN ? AND ? GROUP BY date";
				$stmt = $conn->prepare($sql);
