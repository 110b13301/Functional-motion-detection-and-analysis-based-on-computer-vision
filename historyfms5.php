...
// 根據選擇的日期查詢資料
$sql = "SELECT * FROM recordfms5 WHERE user_id = ? ";
$params = [$user_id];
...
<div class="col-lg-9 col-md-12">
	<div class="row">
		<div class="col-lg-12">
  			<center><h1>主動直膝抬腿歷史紀錄</h1></center>
			<div id="day" class="post-tags my-5 text-uppercase font-size-12 letter-spacing text-center">
				...
				<br><br>
				<div id="content0"></div>
                    <form method="POST" action="historyfms5.php">
		...
		<div id="month" class="post-tags my-5 text-uppercase font-size-12 letter-spacing text-center">
			...
			<?php
				...
				$sql = "SELECT date, MAX(total_record) as max_total_record FROM recordfms5 WHERE user_id = ? AND date BETWEEN ? AND ? GROUP BY date";
				$stmt = $conn->prepare($sql);
