          ...
          <div class="row">
            <div class="col-lg-12 d-flex">
              ...
              <div style="flex: 1; padding-left: 20px; border-left: 2px solid #ccc; font-size: 1.5rem; ">
                ...
                <h2>評分</h2>
                  3分:能在拇指與額頭平齊的位置，同時脊柱沒有彎曲的情況下撐起。<br>
                  2分:能在拇指與鎖骨平齊的位置，同時脊柱沒有彎曲的情況下撐起。<br>
                  1分:無法在拇指與鎖骨平齊的位置撐起。<br>
                  0分:在執行過程中感到疼痛。
              </div>
            </div>
          </div>
...
const total_record = parseInt(localStorage.getItem('score')) ;
...
document.getElementById('historyBtn').addEventListener('click', () => {
    ...
    fetch('recordfms6.php', {
      ...
      .then(result => {
          alert('資料已成功提交！');
          console.log(result);
          window.location.href = 'historyfms6.php';
      })
      .catch(error => {
