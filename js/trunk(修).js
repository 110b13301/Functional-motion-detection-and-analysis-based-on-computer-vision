...
function playSE() {
  if ((pointDetect == false || checkCondition == false) && SE_stop == false) {
...
function onResults(results) {
  ...
  if (results.poseLandmarks) {
    ...
    document.getElementById('left-arm-angle').textContent = `Left Arm Angle: ${pointDetect}`;
