...
$sql = "INSERT INTO recordfms3 (sport_id, user_id, total_record, score_L, score_R, tibial, L_distance, R_distance, date, time)
        VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?)";
...
$stmt->bind_param("siiddddsss", $sport_id, $user_id, $total_record, $score_L, $score_R, $tibial, $L_distance, $R_distance, $date, $time);
